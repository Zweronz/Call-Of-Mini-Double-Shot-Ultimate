...
public class UIJoystickButtonEx : UIButtonBase
{
	public enum Command
	{
		Down = 0,
	...
	public override bool HandleInput(UITouchInner touch)
	{
		...
		float num5 = touch.position.x - m_Center.x;
		float num6 = touch.position.y - m_Center.y;
		m_Distance = Mathf.Sqrt(num5 * num5 + num6 * num6);
		if (PtInRect(touch.position))
		{
			m_FingerId = touch.fingerId;
			UpdatePosition();
