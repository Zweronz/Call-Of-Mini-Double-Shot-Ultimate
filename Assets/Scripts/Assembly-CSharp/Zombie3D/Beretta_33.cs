...
namespace Zombie3D
{
	public class Beretta_33 : Weapon
	{
		protected float gunFireTimer = -1f;

		protected float gunFireShowTime = 0.03f;

		protected Vector3 bulletPosOffset = new Vector3(0f, 0.273f, 2.545f);
		...
		public override void Init(Player owner)
		{
			...
			m_WeaponBulletPool.Init("BulletPool - Beretta_33", gConf.weaponBullets[(int)(GetWeaponType() - 1)], 4);
			m_WeaponBulletShellsPool = new WeaponBulletsShellPool();
			m_WeaponBulletShellsPool.Init("BulletShellsPool - Beretta_33", gConf.BulletShell01, 1f, 4);
			m_WeaponBulletHitParticlesPool = new WeaponBulletsHitParticlePool();
			m_WeaponBulletHitParticlesPool.Init("BulletHitParticlesPool - Beretta_33", gConf.weaponBulletHitParticles[(int)(GetWeaponType() - 1)], 4);
